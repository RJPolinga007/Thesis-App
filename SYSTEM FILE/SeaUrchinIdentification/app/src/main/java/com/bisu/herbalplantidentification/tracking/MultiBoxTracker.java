...
package com.bisu.herbalplantidentification.tracking;
...
import com.bisu.herbalplantidentification.CameraActivity;
...
public class MultiBoxTracker {
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      CameraActivity.setViewBTN(recognition.title);
