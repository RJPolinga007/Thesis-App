...
public class AdminViewUrchinDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_urchin_details);
    ...
    private void deleteUrchin() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                StringRequest stringRequestDeleteUrchin = new StringRequest(Request.Method.POST, Constants.URL_DELETE_URCHIN_ITEM,
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if(!jsonObject.getBoolean("error")){
                                        Toast.makeText(AdminViewUrchinDetails.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(getApplicationContext(), Browse_Info.class));
                                        finish();
                                    }else{
                                        Toast.makeText(AdminViewUrchinDetails.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                progressDialog.dismiss();
                                Toast.makeText(AdminViewUrchinDetails.this, "Some error occured: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }){
                    @Nullable
                    @Override
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(AdminViewUrchinDetails.this);
