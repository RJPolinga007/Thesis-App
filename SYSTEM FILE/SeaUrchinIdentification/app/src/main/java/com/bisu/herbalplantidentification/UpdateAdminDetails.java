...
public class UpdateAdminDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idTV.setText( "" + SharedPrefAdminManager.getInstance(this).getId());
        usernameET.setText(SharedPrefAdminManager.getInstance(this).getUsername());
        emailET.setText(SharedPrefAdminManager.getInstance(this).getEmail());
        passwordET.setText("cannot be shown for security purposes");

        editEmailET.setText(SharedPrefAdminManager.getInstance(this).getEmail());
    ...
    private void updateInfo() {
        int id = SharedPrefAdminManager.getInstance(this).getId();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE_INFO_USER,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!jsonObject.getBoolean("error")){
                                ...
                                Toast.makeText(UpdateAdminDetails.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(UpdateAdminDetails.this, "Connection Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }){
            @Nullable
            @Override
