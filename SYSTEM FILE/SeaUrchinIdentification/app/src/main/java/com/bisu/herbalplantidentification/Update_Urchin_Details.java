...
public class Update_Urchin_Details extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE_INFO_USER,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!jsonObject.getBoolean("error")){
                                ...
                                Toast.makeText(Update_Urchin_Details.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Update_Urchin_Details.this, "Connection Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }){
            @Nullable
            @Override
