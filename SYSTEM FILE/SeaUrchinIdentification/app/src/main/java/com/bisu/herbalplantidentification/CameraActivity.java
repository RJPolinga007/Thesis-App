...
//        CompoundButton.OnCheckedChangeListener,
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    species = findViewById(R.id.spinner);
//    String[] fish = {"Bangus","Tilapia","Tamarung","Danggit","Molmol","Pot-pot","Samolok","Burot","Katambak","Mansi","Tulingan"};
//    ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,fish);
//    species.setAdapter(adapter1);

    species.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
      @Override
      public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        selectedFish = (String)adapterView.getItemAtPosition(i);
        String val = (String)adapterView.getItemAtPosition(i);
//        Toast.makeText(getApplicationContext(),"Selected Fish"+val,Toast.LENGTH_LONG).show();
      }
    ...
    viewD = findViewById(R.id.viewBTN);
    ...
    viewD.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if(m_id == null){
          Toast.makeText(CameraActivity.this, "None Detected", Toast.LENGTH_SHORT).show();
        }
        else {
          Intent i = new Intent(CameraActivity.this, MainActivity.class);
          i.putExtra("name",m_id);
          startActivity(i);
        }
      }
    });
  ...
  public static void setViewBTN(String id){
      m_id = id;
