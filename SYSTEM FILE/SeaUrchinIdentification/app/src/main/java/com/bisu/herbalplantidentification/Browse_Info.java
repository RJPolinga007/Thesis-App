...
public class Browse_Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_viewlist_urchin);
                    ...
                    if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                SimpleAdapter adapter = new SimpleAdapter(Browse_Info.this, data,
                                        R.layout.activity_admin_urchin_listview, new String[]{"name_urchin", "scientific_name", "local_name", "description_urchin", "status"},
                                ...
                                simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Intent intent = new Intent(Browse_Info.this, AdminViewUrchinDetails.class);
